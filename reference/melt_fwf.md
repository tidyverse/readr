...
- col_positions:
  ...
  [`fwf_widths()`](https://readr.tidyverse.org/reference/read_fwf.md) or
...
[`melt_table()`](https://readr.tidyverse.org/reference/melt_table.md) to
melt fixed width files where each column is separated by whitespace, and
[`read_fwf()`](https://readr.tidyverse.org/reference/read_fwf.md) for
the conventional way to read rectangular data from fixed width files.
