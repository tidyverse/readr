...
Thanks for using readr! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/tidyverse/readr/issues/new).
...
requests](https://github.com/tidyverse/readr/issues) to make sure the
