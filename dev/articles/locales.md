...
[`read_fwf()`](https://readr.tidyverse.org/dev/reference/read_fwf.md) or
...
[`read_csv()`](https://readr.tidyverse.org/dev/reference/read_delim.md)
and fields, in this vignette I’m going to use the `parse_*()` functions.
...
[`locale()`](https://readr.tidyverse.org/dev/reference/locale.md) is
