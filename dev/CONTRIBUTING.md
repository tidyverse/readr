...
This outlines how to propose a change to readr. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("tidyverse/readr", fork = TRUE)`.
...
of Conduct](https://readr.tidyverse.org/dev/CODE_OF_CONDUCT.md). By
