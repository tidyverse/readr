...
#> [[1]]
#> [1] "/tmp/RtmpgfiRMd/file18d692f4a4d"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x56118f7f8088>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmpgfiRMd/file18d630fd8adf"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmpgfiRMd/file18d6501a49c9"
#> 
#> $skip
#> [1] 0
#> 
