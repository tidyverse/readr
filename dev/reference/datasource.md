...
#> [[1]]
#> [1] "/tmp/Rtmp3AqrSx/file19cd7bd8e3a2"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x558d0c584710>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/Rtmp3AqrSx/file19cdb7c9b87"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/Rtmp3AqrSx/file19cd7b7c450c"
#> 
#> $skip
#> [1] 0
#> 
