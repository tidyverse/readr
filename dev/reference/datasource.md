...
#> [[1]]
#> [1] "/tmp/RtmpJT3MrT/file196852386a00"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x55a0dcddf418>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmpJT3MrT/file19686f038a78"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmpJT3MrT/file19682713c001"
#> 
#> $skip
#> [1] 0
#> 
