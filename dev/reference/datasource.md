...
#> [[1]]
#> [1] "/tmp/RtmpqF7Dlu/file18ca2578f6bb"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x558663bc2078>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmpqF7Dlu/file18ca55ccd22b"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmpqF7Dlu/file18ca63fbb1e6"
#> 
#> $skip
#> [1] 0
#> 
