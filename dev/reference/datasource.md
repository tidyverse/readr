...
#> [[1]]
#> [1] "/tmp/RtmpHbqZlz/file1dcf15ab7131"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x55f120addef8>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmpHbqZlz/file1dcf6fd4a2b6"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmpHbqZlz/file1dcf70a92c53"
#> 
#> $skip
#> [1] 0
#> 
