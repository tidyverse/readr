...
#> [[1]]
#> [1] "/tmp/RtmpN9L7YC/file18d22e10f8fc"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x55e6ecba40c0>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmpN9L7YC/file18d239969ef9"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmpN9L7YC/file18d27004f23f"
#> 
#> $skip
#> [1] 0
#> 
