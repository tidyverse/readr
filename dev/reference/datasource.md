...
#> [[1]]
#> [1] "/tmp/RtmpbzmOhy/file18d8752962b5"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x55c9ec04e588>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmpbzmOhy/file18d8b3d4646"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmpbzmOhy/file18d84027f671"
#> 
#> $skip
#> [1] 0
#> 
