...
#> [[1]]
#> [1] "/tmp/RtmpK9eWOQ/file1ede28826e62"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x56004a967c58>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmpK9eWOQ/file1ede1da861eb"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmpK9eWOQ/file1ede78dec083"
#> 
#> $skip
#> [1] 0
#> 
