...
#> [[1]]
#> [1] "/tmp/Rtmpm4cvuk/file194927893922"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x562f54dd3518>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/Rtmpm4cvuk/file19494cddc30"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/Rtmpm4cvuk/file19491dafd414"
#> 
#> $skip
#> [1] 0
#> 
