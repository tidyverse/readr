...
#> [[1]]
#> [1] "/tmp/RtmpVEMZX9/file18c5141dc54a"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x55ee79075160>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmpVEMZX9/file18c525cd125b"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmpVEMZX9/file18c521a8bc8e"
#> 
#> $skip
#> [1] 0
#> 
