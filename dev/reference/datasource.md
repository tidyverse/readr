...
#> [[1]]
#> [1] "/tmp/RtmpRGzZBM/file18ee3a666519"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x55615329ace8>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmpRGzZBM/file18ee29faea9e"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmpRGzZBM/file18ee767a89fa"
#> 
#> $skip
#> [1] 0
#> 
