...
#> [[1]]
#> [1] "/tmp/RtmpgFVrKJ/file18ec1fcba78b"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x5618afd67550>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmpgFVrKJ/file18ec523500a9"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmpgFVrKJ/file18ec4cf438d2"
#> 
#> $skip
#> [1] 0
#> 
