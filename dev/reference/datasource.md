...
#> [[1]]
#> [1] "/tmp/Rtmpsy4dRY/file1c0f64a8e94f"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x56111d56ebc8>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/Rtmpsy4dRY/file1c0f5c27c9ba"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/Rtmpsy4dRY/file1c0f48199713"
#> 
#> $skip
#> [1] 0
#> 
