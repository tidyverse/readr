...
#> [[1]]
#> [1] "/tmp/RtmpGeeFUQ/file1acc46abe9ef"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x55e427018718>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmpGeeFUQ/file1acc6be323a8"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmpGeeFUQ/file1acc43805edb"
#> 
#> $skip
#> [1] 0
#> 
