...
#> [[1]]
#> [1] "/tmp/RtmpNl5rkS/file19033740393e"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x562a3fbbe1a0>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmpNl5rkS/file19037746ab86"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmpNl5rkS/file19037c3672b2"
#> 
#> $skip
#> [1] 0
#> 
