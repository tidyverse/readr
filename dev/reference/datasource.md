...
#> [[1]]
#> [1] "/tmp/RtmpTrWMhS/file1a69244fc019"
#> 
#> $skip
#> [1] 0
#> 
...
#> 
#> $env
#> <environment: 0x55e4e16e34f8>
#> 
#> attr(,"class")
#> [1] "source_file" "source"     
datasource(readr_example("mtcars.csv.zip"))
#> [[1]]
#> [1] "/tmp/RtmpTrWMhS/file1a6975de0d8"
#> 
#> $skip
#> [1] 0
#> 
...
datasource(con)
#> [[1]]
#> [1] "/tmp/RtmpTrWMhS/file1a69f3d12fe"
#> 
#> $skip
#> [1] 0
#> 
