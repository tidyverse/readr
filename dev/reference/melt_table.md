...
[`melt_fwf()`](https://readr.tidyverse.org/dev/reference/melt_fwf.md) to
melt fixed width files where each column is not separated by whitespace.
[`melt_fwf()`](https://readr.tidyverse.org/dev/reference/melt_fwf.md) is
...
is the conventional way to read tabular data from whitespace-separated
files.
