...
Consistent wrapper around
[`saveRDS()`](https://rdrr.io/r/base/readRDS.html) and
[`readRDS()`](https://rdrr.io/r/base/readRDS.html). `write_rds()` does
not compress by default as space is generally cheaper than time.
...
- ...:
  ...
  Additional arguments to connection function. For example, control the
  space-time trade-off of different compression methods with
  `compression`. See
