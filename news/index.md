...
- [`read_table()`](https://readr.tidyverse.org/reference/read_table.md),
  [`read_log()`](https://readr.tidyverse.org/reference/read_log.md), and
...
Run [`problems()`](https://readr.tidyverse.org/reference/problems.md) on
...
- `read_table2()` has been renamed to
  ...
  [`read_table()`](https://readr.tidyverse.org/reference/read_table.md)
  you can use
  [`read_fwf()`](https://readr.tidyverse.org/reference/read_fwf.md) with
...
- [`problems()`](https://readr.tidyverse.org/reference/problems.md) now
  takes `.Last.value` as its default argument. This lets you run
...
- [`read_rds()`](https://readr.tidyverse.org/reference/read_rds.md) and
  [`write_rds()`](https://readr.tidyverse.org/reference/read_rds.md)
...
- [`read_rds()`](https://readr.tidyverse.org/reference/read_rds.md) can
  now read .Rds files from URLs
...
- It is now possible to generate a column specification from any tibble
  (or data.frame) with
  [`as.col_spec()`](https://readr.tidyverse.org/reference/as.col_spec.md)
...
- [`write_rds()`](https://readr.tidyverse.org/reference/read_rds.md) now
  can specify the Rds version to use. The default value is 2 as it’s
...
- [`read_fwf()`](https://readr.tidyverse.org/reference/read_fwf.md) can
  now accept overlapping field specifications
...
- The `parse_*()` functions and
  [`read_fwf()`](https://readr.tidyverse.org/reference/read_fwf.md) gain
  a `trim_ws` argument to control whether the fields should be trimmed
  before parsing
...
- Added function
  [`read_lines_raw_chunked()`](https://readr.tidyverse.org/reference/read_lines_chunked.md)
...
- `"f"` can now be used as a shortcode for
  [`col_factor()`](https://readr.tidyverse.org/reference/parse_factor.md)
  in [`cols()`](https://readr.tidyverse.org/reference/cols.md) and the
...
- [`problems()`](https://readr.tidyverse.org/reference/problems.md) now
  returns the file path in additional to the location of the error in
  the file ([\#581](https://github.com/tidyverse/readr/issues/581)).
- [`read_csv2()`](https://readr.tidyverse.org/reference/read_delim.md)
...
- [`fwf_cols()`](https://readr.tidyverse.org/reference/read_fwf.md)
  ...
  [`read_fwf()`](https://readr.tidyverse.org/reference/read_fwf.md) with
  named arguments of either column positions or widths
...
- [`spec()`](https://readr.tidyverse.org/reference/spec.md) declarations
  that are long now print properly
...
[`spec()`](https://readr.tidyverse.org/reference/spec.md):
...
[`cols_condense()`](https://readr.tidyverse.org/reference/spec.md) is
used to condense the spec by identifying the most common type and
...
[`write_rds()`](https://readr.tidyverse.org/reference/read_rds.md). In
production scripts, combine this with
...
- [`locale()`](https://readr.tidyverse.org/reference/locale.md) now
...
- [`locale()`](https://readr.tidyverse.org/reference/locale.md) controls
  all the input settings that vary from place-to-place.

- `col_euro_double()` and `parse_euro_double()` have been deprecated.
  Use the `decimal_mark` parameter to
  [`locale()`](https://readr.tidyverse.org/reference/locale.md) instead.
...
- [`cols()`](https://readr.tidyverse.org/reference/cols.md) lets you
  ...
  (e.g. [`col_character()`](https://readr.tidyverse.org/reference/parse_atomic.md))
  or their one letter abbreviation (e.g. `c`).

- [`cols_only()`](https://readr.tidyverse.org/reference/cols.md) allows
  you to load only named columns. You can also choose to override the
  default column type in
  [`cols()`](https://readr.tidyverse.org/reference/cols.md)
  ([\#72](https://github.com/tidyverse/readr/issues/72)).

- [`read_fwf()`](https://readr.tidyverse.org/reference/read_fwf.md) is
  now much more careful with new lines. If a line is too short, you’ll
  get a warning instead of a silent mistake
...
- [`fwf_empty()`](https://readr.tidyverse.org/reference/read_fwf.md) now
  works correctly when `col_names` supplied
...
- [`problems()`](https://readr.tidyverse.org/reference/problems.md) now
  reports column names rather than column numbers
...
- [`write_csv()`](https://readr.tidyverse.org/reference/write_delim.md),
  [`write_delim()`](https://readr.tidyverse.org/reference/write_delim.md),
  and [`write_rds()`](https://readr.tidyverse.org/reference/read_rds.md)
...
- [`write_rds()`](https://readr.tidyverse.org/reference/read_rds.md) and
  [`read_rds()`](https://readr.tidyverse.org/reference/read_rds.md) wrap
  around [`readRDS()`](https://rdrr.io/r/base/readRDS.html) and
