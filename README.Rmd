...
In many cases, these functions will just work: you supply the path to a file and you get a tibble back.
...
This is useful because it allows you to check that the columns have been read in as you expect, and if they haven't, you can use `spec()` to retrieve the column specifications then copy and paste into a new call:
