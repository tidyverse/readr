...
[`locale()`](https://readr.tidyverse.org/reference/locale.md), as
described in
...
- [`parse_date()`](https://readr.tidyverse.org/reference/parse_datetime.md)
  ...
  [`locale()`](https://readr.tidyverse.org/reference/locale.md). The
...
[`col_skip()`](https://readr.tidyverse.org/reference/col_skip.md) and
...
[`spec_tsv()`](https://readr.tidyverse.org/reference/spec_delim.md) and
so on:
...
- [`read_fwf()`](https://readr.tidyverse.org/reference/read_fwf.md) for
  fixed-width files
- [`read_log()`](https://readr.tidyverse.org/reference/read_log.md) for
  web log files
...
([`spec()`](https://readr.tidyverse.org/reference/spec.md)) and any
parsing problems
([`problems()`](https://readr.tidyverse.org/reference/problems.md)).
