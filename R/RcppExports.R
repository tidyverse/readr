...
count_char_from_file <- function(x, n = 30L, skip = 0L, comment_ = "", quote_ = "\"", backslash_escape = FALSE, double_escape = FALSE, include_alpha = FALSE, include_num = FALSE) {
    .Call('fastread_count_char_from_file', PACKAGE = 'fastread', x, n, skip, comment_, quote_, backslash_escape, double_escape, include_alpha, include_num)
}

count_char_from_string <- function(x, n = 30L, skip = 0L, comment_ = "", quote_ = "\"", backslash_escape = FALSE, double_escape = FALSE, include_alpha = FALSE, include_num = FALSE) {
    .Call('fastread_count_char_from_string', PACKAGE = 'fastread', x, n, skip, comment_, quote_, backslash_escape, double_escape, include_alpha, include_num)
}
