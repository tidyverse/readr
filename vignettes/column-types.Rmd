...
Note that `parse_guess()` will only guess that a string is a number if it has no leading or trailing characters (after trimming whitespace), otherwise it's too prone to false positives. That means you'll typically needed to explicitly supply the column type for number columns.
