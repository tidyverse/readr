...
Note that once you have the date in R, changing the time zone just changes its printed representation - it still represents the same instants of time.
...
If you don't know what encoding the file uses, try `guess_encoding()`. It's not 100% perfect (as by necessity it's fundamentally a heuristic), but should at least get you pointed in the right direction.
