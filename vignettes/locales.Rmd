...
```{r}
date_names_lang("ko") # Korean
date_names_lang("fr") # French
date_names_lang("mas") # Masai
```

Note that the quality of the translations is variable, especially for the rarer languages. If you discover that they're not quite right for your data, you can customise by using `date_names()`.
